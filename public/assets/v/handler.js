(() => {
  ...
  function p(o) {
    ...
    a.nativeMethods.defineProperty(e.meta, "base", {
      get() {
        return o.document
          ? (a.node.baseURI.get.call(o.document) !== d &&
              ((d = a.node.baseURI.get.call(o.document)), (S = e.sourceUrl(d))),
            S)
          : e.meta.url.href;
      },
    }),
      ...
      a.element.hookProperty([x, L, O, T], "href", {
      ...
      a.element.hookProperty([y, k, M, g, _, j, v, u, H, E], "src", {
        get: (t, r) => e.sourceUrl(t.call(r)),
        set: (t, r, [l]) => {
          if (
      ...
      a.element.hookProperty([_], "srcset", {
        get: (t, r) =>
