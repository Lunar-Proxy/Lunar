  ...
  function O(a, e) {
    ...
    return `<!DOCTYPE html>
        ...
        * { background-color: white }
        ...
        <body>
        <h1 id='errorTitle'>Lunar failed processing your request</h1>
        <hr />
        ...
        <li>Troubleshooting the error on the <a href="https://github.com/lunar-services/lunar" target="_blank">GitHub repository</a></li>
        </ul>
